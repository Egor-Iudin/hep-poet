...
process.myneutrinos = cms.EDAnalyzer('GenParticleAnalyzer',
    pruned         = cms.InputTag("prunedGenParticles"),
    input_particle = cms.vstring("1:12","1:-12","1:14","1:-14","1:16","1:-16")
)

process.mytruthquarks = cms.EDAnalyzer('GenParticleAnalyzer',
    pruned         = cms.InputTag("prunedGenParticles"),
    input_particle = cms.vstring("1:5","1:-5")
)

process.mygenmets = cms.EDAnalyzer('MetAnalyzer',
    mets    = cms.InputTag("genMetTrue"),
    rawmets = cms.InputTag("")
)
